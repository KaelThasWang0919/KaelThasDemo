...
import com.kaelthas.demo.databinding.ActivityCamera2Binding;
...
public class Camera2Activity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCamera2Binding binding= DataBindingUtil.setContentView(this, R.layout.activity_camera2);
        mCameraManager = (CameraManager) getSystemService(CAMERA_SERVICE);
        mTextureView =binding.tvCamera;
        mCaptureBtn = binding.ivCamera;
